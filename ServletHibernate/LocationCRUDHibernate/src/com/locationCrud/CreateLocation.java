...
public class CreateLocation extends HttpServlet{
	...
	private void doService(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		writer.write("<title>Create Location Page</title>");
		...
		writer.write("<td><input type='text' id='streetAdd' name='streetAdd' value =''></td>");
		writer.write("</tr>");
		writer.write("<tr>");
		writer.write("<td>Postal Code :</td>");
		writer.write("<td><input type='text' id='postalCode' name='postalCode' value =''></td>");
		writer.write("</tr>");
		writer.write("<tr>");
		writer.write("<td>City :</td>");
		writer.write("<td><input type='text' id='city' name='city' value =''></td>");
		writer.write("</tr>");
		writer.write("<tr>");
		writer.write("<td>State Province:</td>");
		writer.write("<td><input type='text' id='stateProvince' name='stateProvince' value =''></td>");
		writer.write("</tr>");
		writer.write("<tr>");
		writer.write("<td>Country Id:</td>");
		writer.write("<td><input type='text' id='countryId' name='countryId' value =''></td>");
		writer.write("</tr>");
		writer.write("<tr>");
