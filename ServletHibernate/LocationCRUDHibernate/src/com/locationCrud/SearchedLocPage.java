...
public class SearchedLocPage extends HttpServlet{

	public SearchedLocPage() {
		super();
	}
	...
	private void doService(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(locEntity != null){
			...
			writer.write("<title>Searched Location Page</title>");
			writer.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/mytheme.css\">");
			writer.write("</head>");
			writer.write("<script type='text/javascript' src='js/findpage.js'></script>");
			writer.write("<body>");
			writer.write("<form id='findpage' name='findpage'>");
			...
			writer.write("<head>");
			writer.write("<meta charset=\"ISO-8859-1\">");
			writer.write("<title>Find Location Page</title>");
			writer.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/mytheme.css\">");
			writer.write("</head>");
			writer.write("<script type='text/javascript' src='js/findpage.js'></script>");
			writer.write("<body>");
