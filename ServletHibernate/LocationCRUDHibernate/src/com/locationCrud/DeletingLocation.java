...
public class DeletingLocation extends HttpServlet{
	...
	private void doService(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(locEntity != null){
			...
			writer.write("<title>Deleting Location Page</title>");
			writer.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/mytheme.css\">");
			writer.write("</head>");
			writer.write("<script type='text/javascript' src='js/deletepage.js'></script>");
			writer.write("<body>");
			writer.write("<form id='deletepage' name='deletepage'>");
			...
			writer.write("</tr>");
			writer.write("<tr>");
			writer.write("<td colspan=3><input type='button' class=\"button button2\" onclick='deleteLoc()' value='Delete Location'/></td>");
			...
			writer.write("<head>");
			writer.write("<meta charset=\"ISO-8859-1\">");
			writer.write("<title>Delete Location Page</title>");
			writer.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/mytheme.css\">");
			writer.write("</head>");
			writer.write("<script type='text/javascript' src='js/deletepage.js'></script>");
			writer.write("<body>");
