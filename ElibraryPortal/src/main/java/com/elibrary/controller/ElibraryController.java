...
import com.apache.elibrary.webservice.service.BookDetail;
import com.apache.elibrary.webservice.service.ElibraryException_Exception;
import com.apache.elibrary.webservice.service.ElibraryService;
import com.apache.elibrary.webservice.service.IssueBookDetail;
import com.apache.elibrary.webservice.service.LibrarianDetail;
import com.apache.elibrary.webservice.service.ViewIssuedBook;
...
public class ElibraryController {
		private static Logger LOG =Logger.getLogger(ElibraryController.class);
		...
		public JsonResponse getLibrarianDetail(){
			...
			try{
			 ArrayList<LibrarianDetail> libDetail =(ArrayList<LibrarianDetail>) elibraryService.getLibrarians();
			 JsonResponse response = new JsonResponse();
		...
		public JsonResponse getAllBooks(){
			...
			try{
			 ArrayList<BookDetail> bookDetail =(ArrayList<BookDetail>) elibraryService.getAllBooks();
			 JsonResponse response = new JsonResponse();
		...
		public JsonResponse saveStudentBookDetail(@RequestParam("studentId") Long studentId, @RequestParam("bookId") Long bookId){
			...
			}catch(ElibraryException_Exception elibraryException){
		...
		public JsonResponse getAllIssuedBooks(){
			...
			try{
			 ArrayList<ViewIssuedBook> viewIssuedBookList =(ArrayList<ViewIssuedBook>) elibraryService.getAllIssuedBooks();
			 JsonResponse response = new JsonResponse();
