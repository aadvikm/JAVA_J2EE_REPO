function findDept(){
	if(validate()){
		document.getElementById('findpage').action = '/DeptCrudDropDown/findDept?action=searchedPage';
...
function goHome(){
	document.getElementById('findpage').action = '/DeptCrudDropDown/homePage';
	document.getElementById('findpage').method = 'post';
	document.getElementById('findpage').submit();
}
