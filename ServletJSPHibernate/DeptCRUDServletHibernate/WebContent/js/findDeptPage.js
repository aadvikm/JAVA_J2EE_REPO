function findDept(){
	if(validate()){
		document.getElementById('findDeptPage').action='/DeptCRUDServletHibernate/deptDetails';
...
function goHome(){
	document.getElementById('findDeptPage').action = '/DeptCRUDServletHibernate/home';
