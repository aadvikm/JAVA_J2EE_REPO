<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
        <%@ page import="com.deptcrud.dropdown.DepartmentEntity" %>
        <%@ page import="com.deptcrud.dropdown.DepartmentEntity" %>
     <%@ page import="com.deptcrud.dropdown.Manager" %>
     <%@ page import="com.deptcrud.dropdown.Location" %>
...
<img src='images/deptimg.jpg' style='width:800px;height:150px;'>
...
%>
<option <%= location.getLocationId().longValue() == new Long(request.getParameter("locationId")).longValue() ? "selected" : "" %> value="<%= location.getLocationId()%>"><%= location.getStreetAddress()%></option>
<%}
else{%>
