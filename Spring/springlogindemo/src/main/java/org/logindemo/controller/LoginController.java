package org.logindemo.controller;
...
import org.logindemo.domain.User;
...
public class LoginController {
	...
	public String index(ModelMap model) {
		LOG.info("Inside index method..."+model);
	...
	public ModelAndView showLogin(HttpServletRequest request, HttpServletResponse response) {
		try{
			...
			if(authentication){
				...
				User user = new User(username, "Admin");// Intansiating user object
