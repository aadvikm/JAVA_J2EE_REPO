...
@NamedQueries({
	...
	@NamedQuery(name="getMaxMinAvgSalary", query = "select MIN(e.salary) as MINSAL, MAX(e.salary) AS MAXSAL, AVG(e.salary) as AVGSAL from Employee e"),
	@NamedQuery(name="getDeptMaxMinAvgSalary", query = "select MIN(e.salary) as MINSAL, MAX(e.salary) AS MAXSAL, AVG(e.salary) as AVGSAL from Employee e where e.departmentId = :deptId")
})
public class Employee{
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", commissionPct=" + commissionPct + ", departmentId=" + departmentId
