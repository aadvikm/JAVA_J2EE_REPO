...
public class SubmitProduct extends HttpServlet{
	...
	private void doService(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Integer colorpenQuantity = Integer.parseInt(req.getParameter("colorpenQuantity"));
		Integer colorpenPrice = Integer.parseInt(req.getParameter("colorpenPrice"));
		...
		Product colorpen= new Product();
		colorpen.setName("ColorPen");
		colorpen.setUnitPrice(Double.valueOf(colorpenPrice));
		colorpen.setQuantity(colorpenQuantity);
		colorpen.setItemPrice(Double.valueOf(colorpenPrice*colorpenQuantity));
		...
		productList.add(colorpen);
		//Populate Order Detail
		orderDetail.setOrderDate(new Date());
		orderDetail.setProductList(productList);
		orderDetail.setOrderAmount(pen.getItemPrice()+pencil.getItemPrice()+eraser.getItemPrice()+colorpen.getItemPrice());
		...
		writer.write("<form action='/ShoppingCartPractice/placeOrder' method='post'>");
